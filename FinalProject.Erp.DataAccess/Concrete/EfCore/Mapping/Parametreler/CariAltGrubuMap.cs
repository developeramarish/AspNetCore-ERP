...
{
    public class CariAltGrubuMap : IEntityTypeConfiguration<CariAltGrubu>
    {
        public void Configure(EntityTypeBuilder<CariAltGrubu> builder)
        {
            builder.ToTable("CariAltGrubu");
            builder.HasKey(a => a.Id);
            builder.Property(a => a.Id).UseIdentityColumn();
            builder.Property(a => a.Kod).IsRequired().HasMaxLength(25).HasColumnType("varchar");
            builder.Property(a => a.CariAltGrubuAdi).IsRequired().HasMaxLength(50).HasColumnType("varchar");
