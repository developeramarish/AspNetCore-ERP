...
{
    public class CariGrubuMap : IEntityTypeConfiguration<CariGrubu>
    {
        public void Configure(EntityTypeBuilder<CariGrubu> builder)
        {
            builder.ToTable("CariGrubu");
            builder.HasKey(a => a.Id);
            builder.Property(a => a.Id).UseIdentityColumn();
            builder.Property(a => a.Kod).IsRequired().HasMaxLength(25).HasColumnType("varchar");
            builder.HasIndex(a => a.Kod).IsUnique();
            builder.Property(a => a.CariGrubuAdi).IsRequired().HasMaxLength(50).HasColumnType("varchar");
            builder.HasIndex(a => a.CariGrubuAdi).IsUnique();
