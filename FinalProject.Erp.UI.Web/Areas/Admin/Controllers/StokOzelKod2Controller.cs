...
namespace FinalProject.Erp.UI.Web.Areas.Admin.Controllers
{
    ...
    [Area("Admin")]
    public class StokOzelKod2Controller : Controller
    {
        ...
        public StokOzelKod2Controller(IOzelKodService ozelKodService, IMapper mapper, IDosyaService dosyaService)
        {
        ...
        {
            return _ozelKodService.GetAllByActiveCars(_durum, OzelKodKart.Stok, OzelKodSira.Sira2).ToList();
        }
        ...
        public IActionResult Add()
        {
            ...
            {
                Kod = _ozelKodService.NewCode(KartTuru.OzelKod, a => a.Kod, a => a.OzelKodTip == (int)OzelKodKart.Stok && a.OzelKodSira == (int)OzelKodSira.Sira2)
            });
        }
