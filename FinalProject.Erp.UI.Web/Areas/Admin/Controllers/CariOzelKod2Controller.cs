...
namespace FinalProject.Erp.UI.Web.Areas.Admin.Controllers
{
    ...
    [Area("Admin")]
    public class CariOzelKod2Controller : Controller
    {
        private readonly IOzelKodService _ozelKodService;
        private readonly IMapper _mapper;
        private readonly IDosyaService _dosyaService;
        private static bool _durum;
        public CariOzelKod2Controller(IOzelKodService ozelKodService, IMapper mapper, IDosyaService dosyaService)
        {
        ...
        {
            return _ozelKodService.GetAllByActiveCars(_durum, OzelKodKart.Cari, OzelKodSira.Sira2).ToList();
        }
        ...
        public IActionResult Add()
        {
            ...
            {
                Kod = _ozelKodService.NewCode(KartTuru.OzelKod, a => a.Kod, a => a.OzelKodTip == (int)OzelKodKart.Cari && a.OzelKodSira == (int)OzelKodSira.Sira2)
            });
        }
        ...
        public IActionResult Add(OzelKodAddDto model)
        {
            if (ModelState.IsValid)
            {
                ...
                {
                    Kod = model.Kod,
                    OzelKodTip = (int)OzelKodKart.Cari,
                    OzelKodSira = (int)OzelKodSira.Sira2,
