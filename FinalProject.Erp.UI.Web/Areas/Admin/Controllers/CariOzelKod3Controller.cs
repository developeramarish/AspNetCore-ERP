...
namespace FinalProject.Erp.UI.Web.Areas.Admin.Controllers
{
    ...
    [Area("Admin")]
    public class CariOzelKod3Controller : Controller
    {
        ...
        public CariOzelKod3Controller(IOzelKodService ozelKodService, IMapper mapper, IDosyaService dosyaService)
        {
        ...
        {
            return _ozelKodService.GetAllByActiveCars(_durum, OzelKodKart.Cari, OzelKodSira.Sira3).ToList();
        }
        ...
        public IActionResult Add()
        {
            ...
            {
                Kod = _ozelKodService.NewCode(KartTuru.OzelKod, a => a.Kod, a => a.OzelKodTip == (int)OzelKodKart.Cari && a.OzelKodSira == (int)OzelKodSira.Sira3)
            });
        }
