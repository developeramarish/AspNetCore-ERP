...
{
    public class StokTurMap : IEntityTypeConfiguration<StokTur>
    {
        public void Configure(EntityTypeBuilder<StokTur> builder)
        {
            builder.ToTable("StokTur");
            builder.HasKey(a => a.Id);
            builder.Property(a => a.Id).UseIdentityColumn();
            builder.Property(a => a.Kod).IsRequired().HasMaxLength(25).HasColumnType("varchar");
            builder.HasIndex(a => a.Kod).IsUnique();
            builder.Property(a => a.StokTurAdi).IsRequired().HasMaxLength(50).HasColumnType("varchar");
            builder.HasIndex(a => a.StokTurAdi).IsUnique();
