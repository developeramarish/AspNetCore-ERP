...
namespace FinalProject.Erp.UI.Web.Areas.Admin.Controllers
{
    ...
    [Area("Admin")]
    public class StokOzelKod1Controller : Controller
    {
        private readonly IOzelKodService _ozelKodService;
        private readonly IMapper _mapper;
        private readonly IDosyaService _dosyaService;
        private static bool _durum;
        public StokOzelKod1Controller(IOzelKodService ozelKodService, IMapper mapper, IDosyaService dosyaService)
        {
        ...
        {
            return _ozelKodService.GetAllByActiveCars(_durum, OzelKodKart.Stok, OzelKodSira.Sira1).ToList();
        }
        ...
        public IActionResult Add()
        {
            ...
            {
                Kod = _ozelKodService.NewCode(KartTuru.OzelKod, a => a.Kod, a => a.OzelKodTip == (int)OzelKodKart.Stok && a.OzelKodSira == (int)OzelKodSira.Sira1)
            });
        }
