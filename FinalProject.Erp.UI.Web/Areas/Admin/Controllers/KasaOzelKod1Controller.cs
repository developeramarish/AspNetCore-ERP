...
namespace FinalProject.Erp.UI.Web.Areas.Admin.Controllers
{
    ...
    [Area("Admin")]
    public class KasaOzelKod1Controller : Controller
    {
        ...
        public KasaOzelKod1Controller(IOzelKodService ozelKodService, IMapper mapper, IDosyaService dosyaService)
        {
        ...
        {
            return _ozelKodService.GetAllByActiveCars(_durum, OzelKodKart.Kasa, OzelKodSira.Sira1).ToList();
        }
        ...
        public IActionResult Add()
        {
            ...
            {
                Kod = _ozelKodService.NewCode(KartTuru.OzelKod, a => a.Kod, a => a.OzelKodTip == (int)OzelKodKart.Kasa && a.OzelKodSira == (int)OzelKodSira.Sira1)
            });
        }
        ...
        public IActionResult Add(OzelKodAddDto model)
        {
            if (ModelState.IsValid)
            {
                ...
                {
                    Kod = model.Kod,
                    OzelKodTip = (int)OzelKodKart.Kasa,
